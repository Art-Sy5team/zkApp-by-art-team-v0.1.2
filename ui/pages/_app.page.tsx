...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp Art-Sy5Team</title>
        <meta name="description" content="ZkApp By ART team" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://discord.com/users/728123433262514259" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/Art-Sy5team" target="_blank" rel="noopener noreferrer" >
						<span className={styles.gitIcon}> </span>
					</a>

				<a style={{display: 'block'}} href="https://twitter.com/ArtSy5team" target="_blank" rel="noopener noreferrer" >
